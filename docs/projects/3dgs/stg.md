...
![Technicolor 定性对比](../image/stg/fig09_qualitative_technicolor.png)

![轻量版 8K 实时渲染演示](../image/stg/fig10_lite_demo.png)
...
| 变体 | PSNR | 说明 |
|------|------|------|
| 无时间不透明度 | 31.0 | 无法建模瞬态内容，下降最大 |
| 无多项式运动 | 32.6 | 运动表达受限 |
| 无多项式旋转 | 33.4 | 影响较小 |
| 无特征溅射 | 33.0 | 回退 SH 路线，体积增且 LPIPS 变差 |
| 无引导采样 | 33.3 | 远端稀疏区质量下降 |
| 完整方法 | 33.6 | 完整流程 |
