...
- **本科** | 南京大学 | 智能软件与工程学院 | 软件工程（智能化软件） | 2022 - 2026
...
- **AI产品实习生** | 绚星智慧科技 | 2026.1 - 2026.3
  - 主导 Agent 产品需求分析，设计完整的 system prompt，开发 tools、skills，支持多技能场景切换。
  - 基于 LangGraph 状态图和 Agentickit 企业级框架构建销售 Agent，使用 A2A 协议实现 Agent 间协作通信。
